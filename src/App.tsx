...
function App() {
  ...
  return (
    <div
      className="app-shell relative flex min-h-screen flex-col items-center justify-center bg-cover bg-center p-4 transition-all duration-700"
      style={{
        background: wallpaper ? `url(${wallpaper}) center/cover` : gradient,
      }}
    >
      <div className="absolute inset-0 bg-black/30" />
      <div className="hero-content relative z-10 flex animate-fade-in select-none flex-col items-center gap-8">
        <Clock />
